...
// c1->SetFillColor(41);
   ...
   c1->cd(0); 
	...
	//  /////////////////////////////////////////////////////
	a.cd();
    TH1F *hptDiffa = (TH1F*)DifftrackerPoutPgen->Clone();
 
// THStack *hs = new THStack("hs",GenDilMass0_Zp331M1000->GetTitle());
 hptDiffa->SetName("DifftrackerPoutPgen");
...
//hs->Add(GenDilMass0_Zp331M1000);
 ...
 /////////////////////////////////////////////////////
	...
	TH1F *hptDiffb = (TH1F*)DifftrackerPoutPgen->Clone();
	hptDiffb->SetName("DifftrackerPoutPgen");
...
//	c1->cd();hptDiffb->Draw();
 ...
 /////////////////////////////////////////////////////
        ...
        TH1F *hptDiffc = (TH1F*)DifftrackerPoutPgen->Clone();
        hptDiffc->SetName("DifftrackerPoutPgen");
        hptDiffc->SetLineColor(kRed);
        hptDiffc->SetLineStyle(3);
...
// 	c1->cd();hptDiffc->Draw("same");
	...
	leg->Draw();
	c1->SaveAs("DifftrackerPoutPgen_FullFast.png");
