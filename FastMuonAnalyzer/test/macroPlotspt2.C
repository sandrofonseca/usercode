...
/////////////////////////////////////////////////////////////////// 
 ...
 TFile *b = new TFile("TrackerMuonAnalyzer_FASTfromFILE_MuonBrem.root");	
...
// c1->SetFillColor(41);
   ...
   c1->cd(0); 
	...
	//  /////////////////////////////////////////////////////
	a.cd();
    TH1F *hptDiffa = (TH1F*)trackerPtOn->Clone();
 
// THStack *hs = new THStack("hs",GenDilMass0_Zp331M1000->GetTitle());
 hptDiffa->SetName("trackPtOut");
...
//hs->Add(GenDilMass0_Zp331M1000);
 ...
 /////////////////////////////////////////////////////
	...
	TH1F *hptDiffb = (TH1F*)trackerPtOn->Clone();
	hptDiffb->SetName("trackPtOut");
	hptDiffb->SetLineColor(kMagenta);
	hptDiffb->SetLineStyle(2);
	hptDiffb->SetLineWidth(2); 
