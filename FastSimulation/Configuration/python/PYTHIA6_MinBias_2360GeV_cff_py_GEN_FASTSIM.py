...
# with command line options: Configuration/GenProduction/python/PYTHIA6_MinBias_2360GeV_cff.py -s GEN,FASTSIM --pileup=NoPileUp --conditions=STARTUP3X_V8L::All --eventcontent=RECODEBUG --beamspot=Early900GeVCollision --datatier GEN-SIM-DIGI-RECO -n 100 --no_exec
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_MinBias_2360GeV_cff_py_GEN_FASTSIM.root'),
